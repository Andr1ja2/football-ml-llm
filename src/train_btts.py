# Trains BTTS prediction models, compares candidates, and saves the production model.
...
CALIBRATION_PATH = Path(__file__).resolve().parent.parent / "data" / "processed" / "calibration_btts.png"
...
# written to model_btts.pkl and used by the prediction pipeline.
...
def save_calibration_plot(y_true: np.ndarray, y_proba: np.ndarray, path: Path) -> None:
    ...
    ax.set_title("BTTS Model Calibration")
